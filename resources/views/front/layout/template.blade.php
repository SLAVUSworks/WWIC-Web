        ...
        <footer class="bg-dark text-center text-lg-start bg-body-tertiary text-muted">
            ...
            <div class="container text-center text-md-start mt-5">
                ...
                <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                    <!-- Content -->
                    <h6 class="text-uppercase fw-bold mb-1">{{ $config['footle1'] ?? "No data"}}</h6>
                    <div class="col-md-4"><img src="{{ asset('front/img/wwic-icon.png') }}" width="150px"></div>
                    <div class="col-md-8">
                        <p style="text-align: justify">{!! $config['footdesc1'] ?? "No data" !!}</p> 
                    </div>
                ...
                <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                    <!-- Content -->
                    <h6 class="text-uppercase fw-bold">{{ $config['footle2'] ?? "No data" }}</h6>
                    <div class="col-md-4 mt-5 mb-5 pb-3 pt-2"><img src="{{ asset('front/img/ww-icon.png') }}" width="150px"></div>
                    <div class="col-md-8">
                        <p style="text-align: justify">{!! $config['footdesc2'] ?? "No data" !!}</p> 
                    </div>
                ...
                <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                    <!-- Content -->
                    <h6 class="text-uppercase fw-bold">{{ $config['footle3'] ?? "No data" }}</h6>
                    <div class="col-md-4 mt-1 mb-1"><img src="{{ asset('front/img/slavus-oc.png') }}" width="150px"></div>
                    <div class="col-md-8">
                        <p style="text-align: justify">{!! $config['footdesc3'] ?? "No data" !!}</p> 
                    </div>
                ...
                <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
                    ...
                    <h6 class="text-uppercase fw-bold mb-4">
                        {{ $config['footle4'] ?? "No data" }}
                    </h6>
                    {!! $config['footdesc4'] ?? "No data" !!}
                </div>
                <!-- Grid column -->
                </div>
                <!-- Grid row -->
            ...
            <div class="text-center p-4" style="background-color: rgba(0, 0, 0, 0.05);">
                {!! $config['license'] ?? "No data" !!}
            <p>{{ date('Y') }} :</p>
            {!! $config['copyright'] ?? "No data" !!}
            </div>
            <!-- Copyright -->
        </footer>
        <!-- Footer -->
